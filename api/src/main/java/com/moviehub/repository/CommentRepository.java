...
public interface CommentRepository extends JpaRepository<Comment, UUID> {
    ...
    @Query("SELECT c FROM Comment c LEFT JOIN FETCH c.replies WHERE c.movie = :movie AND c.parentComment IS NULL")
    Page<Comment> findAllTopLevelCommentsWithReplies(Movie movie, Pageable pageable);
